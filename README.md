...
- [x] **Stores data in MongoDB** - Stores users and the events they create
- [x] **Stores credentials in MongoDB** - Stores users and makes sure that they can only see the events they created

## 🚀 WebSocket deliverable

For this deliverable I did the following. I checked the box `[x]` and added a description for things I completed.

- [x] **Backend listens for WebSocket connection** - got that working
- [x] **Frontend makes WebSocket connection** - did that
- [x] **Data sent over WebSocket connection** - They can send messages
- [x] **WebSocket data displayed** - They can also see messages
- [x] **Application is fully functional** - It is fully functional to a sufficient degree
